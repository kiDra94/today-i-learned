...
.month {
  ...
  background-color: #fff; /* White background for the month area */
  border-radius: 8px;
  box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); /* Subtle shadow */
  margin: 10px; /* Add margin around the month */
}
...
.days {
  ...
  padding: 0; /* Remove padding here, add to day */
  overflow-y: auto;
  gap: 5px; /* Add gap between day elements */
}

/* Styling for individual day elements */
.day {
  width: 100%; /* Keep width 100% for list-like structure */
  display: flex;
  flex-direction: column; /* Stack content vertically */
  background-color: #e9ecef; /* Light grey background for days */
  border: 1px solid #ced4da; /* Subtle border */
  border-radius: 5px; /* Rounded corners for days */
  padding: 10px; /* Add padding inside day */
  font-size: 1rem;
...
.event_css {
  font-weight: bold;
  font-style: italic;
  color: #dc3545; /* Reddish color for events */
  margin-top: 5px; /* Space above event */
}

/* Styling for the current day */
.today_css {
  background-color: #ffc107; /* Yellowish color for today */
  border-color: #ffb300;
}

/* Styling for past days */
.past_css {
  background-color: #6c757d; /* Grey color for past days */
  color: #f8f9fa; /* Light text for past days */
  opacity: 0.9; /* Slightly less opaque */
}

/* Specific styling for weekend days */
.weekend_css {
  background-color: #28a745; /* Greenish color for weekends */
  color: #fff; /* White text for weekends */
}

/* Specific styling for past weekend days */
.weekend_css.past_css {
  background-color: #adb5bd; /* Different grey for past weekends */
  color: #495057;
}
...
.overlay {
  ...
  align-items: center;
  background-color: rgba(0, 0, 0, 0.5); /* Darker, more prominent overlay */
...
.popup h3 {
  ...
  margin-bottom: 20px;
  font-size: 1.8rem;
  color: #343a40; /* Darker color for popup title */
}

/* Styling for labels and inputs in the add section */
.popup label {
  display: block; /* Make labels block elements */
  margin-bottom: 15px; /* Space between labels/inputs */
...
#desc {
  min-height: 80px; /* Give more height for TIL description */
...
.popup button:nth-of-type(1) { /* Add button */
...
.popup button:nth-of-type(2) { /* Edit button */
...
.popup button:nth-of-type(3) { /* Close button */
...
.show {
  ...
  background-color: #f8f9fa; /* Light background for displayed items */
  border: 1px solid #e9ecef;
  border-radius: 8px;
  padding: 15px;
  margin-top: 15px; /* Space above each displayed item */
  text-align: left;
  box-shadow: 0 1px 5px rgba(0, 0, 0, 0.08);
}

.show label {
  display: block; /* Labels are block */
  margin-bottom: 10px;
  font-weight: normal; /* Normal weight for displayed labels */
  color: #333;
}

.show input.edit {
  width: 100%; /* Full width inputs in show */
  padding: 8px;
  margin-top: 3px;
  border: 1px solid #ced4da;
  border-radius: 4px;
...
.show button {
  margin-top: 10px; /* Space above buttons in show */
  margin-right: 10px;
  padding: 8px 15px;
  font-size: 0.9rem;
}

.show button:nth-of-type(1) { /* Update button */
...
.show button:nth-of-type(2) { /* Delete button */
  background-color: #dc3545; /* Red */
  color: white;
}
...
@media (min-width: 768px) {
  ...
  .show label {
    flex-basis: 48%; /* Give labels a basis */
